        ...
        >
            <v-row>
                <v-col
                        cols="12"
                >
                    <h1>Как дать денег?</h1>
                    <p>У меня для вас есть несколько вариантов</p>
                </v-col>
            </v-row>
            <v-row>
                <v-col
                ...
                >
                    ...
                    <p>Можно просто скинуть деньги на Яндекс-кошелек: <span v-clipboard:copy="41001572304361">41001572304361</span>
                    </p>
                </v-col>
                <v-col
                        cols="12"
                ...
                >
                    <h2>Альфа-Банк</h2>
                    <p>Можно сделать перевод на карту <a
                            href="https://money.alfabank.ru/p2p/web/transfer/aaleksandrov8361" target="_blank">здесь</a>
                    </p>
                </v-col>
                <v-col cols="12">
